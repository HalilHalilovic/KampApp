        ...
        <div className={style.contentWrap}>
          ...
          <div className={style.textInfoContent}>
            <div className={style.textInfoWrap}>
              <h1 className={style.textInfoTittle}>
                Where work and play come together
              </h1>
              <p className={style.textInfoPara}>
                We are extremely proud of our nursery with its warm caring,
                homely and family orientated atmosphere. With us, children learn
                with confidence in a fun, safe and stimulating environment We
                value each child individually and look forward to sharing with
                you the exciting leaps your child will take during the time with
                us.
              </p>
