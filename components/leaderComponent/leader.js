      ...
      <div className={style.leaderContentWrap}>
        <div className={style.leaderTextWrap}>
          ...
          <p className={style.leaderPara}>
            Leadership is key to supporting and sustaining quality in early childhood education and
            care settings and for creating a stimulating environment for both staff and children.
            Effective leadership establishes a set of organisational conditions that positively
            influence process quality, working conditions and staff engagement in continuous
            professional learning and growth.
          </p>
        </div>
        <div className={style.leaderImgWrap}>
          <div className={style.leaderImg}>
            <Image src={leaderGirl} alt="" />
          </div>
        </div>
      </div>
    </div>
